...
var Menu = React15.forwardRef(function Menu2(inProps, ref) {
  ...
  let activeItemIndex = -1;
  React15.Children.map(children, (child, index2) => {
...
function useControllableReducer(parameters) {
  ...
  const controlledPropsRef = React26.useRef(controlledProps);
  if (true) {
    React26.useEffect(() => {
      Object.keys(controlledProps).forEach((key) => {
...
var Menu3 = React48.forwardRef(function Menu4(props, forwardedRef) {
...
var Modal3 = React54.forwardRef(function Modal4(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    closeAfterTransition = false,
...
var PopperTooltip = React62.forwardRef(function PopperTooltip2(props, forwardedRef) {
  ...
  const [resolvedAnchorElement, setResolvedAnchorElement] = React62.useState(resolveAnchorEl2(anchorEl));
  React62.useEffect(() => {
...
function defaultRenderValue(selectedOptions) {
  ...
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime47.jsx)(React65.Fragment, {
...
var Select = React65.forwardRef(function Select2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime48.jsxs)(React65.Fragment, {
...
var TextareaAutosize = React85.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime65.jsxs)(React85.Fragment, {
...
var InputBase = React90.forwardRef(function InputBase2(inProps, ref) {
  ...
  const inputRef = React90.useRef();
  const handleInputRefWarning = React90.useCallback((instance) => {
    if (true) {
      if (instance && instance.nodeName !== "INPUT" && !instance.focus) {
  ...
  const checkDirty = React90.useCallback((obj) => {
    if (isFilled(obj)) {
      if (onFilled) {
        onFilled();
      }
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-5S27JSUR.js.map
